...
function changeColor(id, color) {
    ...
    // changes image
    document.getElementById("#main-model-s-image").src = 'model_s_' + color + '.png'
}
...
function changeTheme() {
    ...
    if (document.getElementById("#theme-toggle").innerText == "Dark Mode Theme") {
        ...
        document.getElementById("#nav-logo").src = 'tesla_logo_title_white.png'
    }
    else {
        document.getElementById("#theme-toggle").innerText = "Dark Mode Theme"
        document.getElementById("#nav-logo").src = 'tesla_logo_title.png'
    }
